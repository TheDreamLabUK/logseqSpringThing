...
const defaultPanels: Record<string, Panel> = {
  ...
  xr: { // Added default for XR panel
    id: 'xr',
    title: 'XR Settings',
    position: { x: window.innerWidth - 320, y: 20 }, // Position if undocked
    size: { width: 300, height: 400 },
    isOpen: false, // Initially closed
    isCollapsed: false,
    isDocked: true, // Docked right by default
    dockPosition: 'right',
    zIndex: 100,
    groupId: 'rightGroup', // Part of the right group
    activeInGroup: false, // Initially inactive in group
  },
  system: { // Added default for System panel
    id: 'system',
    title: 'System Info',
    position: { x: window.innerWidth - 320, y: 20 }, // Position if undocked
    size: { width: 300, height: 400 },
